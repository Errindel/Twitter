...
if ($result == true) {
    echo "utworzono nowy Tweet";
} else {
    echo "nie utworzono tweeta $result->error";
};
?>
                    ...
                    <table class="table table-hover" id="table-tweet">                                
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><form action="profile.php" method="POST"><button class="btn btn-info btn-xs">Twój profil</button></form></td>
